#include "car_controller/simple_controller.hpp"
  ...
  , theta_(0.0)
{
  ...
  vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>(
    "/car_controller/cmd_vel", 10, std::bind(
      &SimpleController::velCallback, this,
      _1));
  joint_sub_ =
    create_subscription<sensor_msgs::msg::JointState>(
    "/joint_states", 10,
    std::bind(&SimpleController::jointCallback, this, _1));
  odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/car_controller/odom", 10);

  speed_conversion_ << wheel_radius_ / 2, wheel_radius_ / 2, wheel_radius_ / wheel_separation_,
